...
(function() {
  var init = function(obj) {
    ...
    var parent =
      ...
      size +
      "</td>" +
      "<td><div style='overflow:hidden'><div id='totalBar' style='float:left;height:30px;border:1px solid;border-radius:3px'>" +
      ...
      "<ul class='fragment-group hide'>" +
        "</ul></td>" +
        "<td>" +
        "<textarea rows='2' cols='50'id='urlpath'>等待上传……</textarea>" +
        "<button class='copypath'>复制地址</button>";
